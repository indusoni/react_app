...
class TicTacToe extends Component{
	...
	AddPlayer(e){
	this._input.selectedOptions.length===2?(this.props.AddPlayers([this._input.selectedOptions[0].value,this._input.selectedOptions[1].value])):alert("select two players");
			...
			<div>
				{
					...
					(<div><h3>Select Any two players</h3><select name= "player[]" ref={(node) => this._input = node} multiple >
				...
				<div>
				<h3>Player : {this.props.TicTacTeo.ActivePlayer}   </h3>
